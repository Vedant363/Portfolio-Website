...
const Footer = () => {
  return (
    <footer className="rounded-full w-1/2 ml-[25%] bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% text-gray-300 py-4 mt-10 shadow-lg shadow-gray-700">
